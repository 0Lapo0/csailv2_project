...
suma = client.chat.completions.create(model=MODEL, messages=st.session_state.messages.append({"role":"system", "content":"summarize the entire chat history except this message"}))
suma